...
\033[1;94m ┈┈┈▕▕KINGS▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕MR ZE▏▏┈┈┈
...
\033[1;91m☞ Auther     : ZEESHAN_KING_BRAND

\033[1;92m☞ WhatsApp   : 03162219719
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/ZEE_BRAND')

	    os.system('cd $HOME && git clone https://github.com/zeeshanking0011/abbasi')
	    ...
	    psb('WhatsApp Num 03162219719✓')

	    psb('WellCome To ZEE_BRAND')

	    psb('Congratulations MR_ZEE Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ Zeeshan✓')

	    psb('🔓Password ☆ King✓')

	    psb('Subscrib My Youtube Channel BLACK WOLF✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/ZEESHAN_ABBASI && python2 Zee.py')
